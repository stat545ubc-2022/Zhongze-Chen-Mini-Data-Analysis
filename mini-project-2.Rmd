...
The data is not tidy. `exterior_fire_escape`, `fire_alarm`, `sprinkler_system`, `emergency_power` and `barrier_free_accessibilty_entr` are facilities of a building and therefore can be tidied into a single column.
